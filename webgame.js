...
function movePlayer() {
  if (keysPressed["ArrowUp"]) {
    ...
    if (
      ...
      for (let i = 0; i <= 3; i++)
        for (let swordskill of swordSkillArray[i]) swordskill.y += playerSpeed;
    } else {
  ...
  if (keysPressed["ArrowLeft"]) {
    ...
    if (
      ...
      for (let i = 0; i <= 3; i++)
        for (let swordskill of swordSkillArray[i]) swordskill.x += playerSpeed;
    } else {
...
let swordSkillArray = [[], [], [], []];
let swordSkillinformation = [[], [], [], []];
let swordSkillX, swordSkillY;

function swordSkill() {
  if (timer % 20 == 0 && keysPressed["z"] && direction == 1) {
    swordSkillArray[0].push({ x: player.x, y: player.y });
    swordSkillinformation[0].push({ x: player.x, y: player.y });
  }
  if (timer % 20 == 0 && keysPressed["z"] && direction == 2) {
    swordSkillArray[1].push({ x: player.x, y: player.y });
    swordSkillinformation[1].push({ x: player.x, y: player.y });
  }
  if (timer % 20 == 0 && keysPressed["z"] && direction == 3) {
    swordSkillArray[2].push({ x: player.x, y: player.y });
    swordSkillinformation[2].push({ x: player.x, y: player.y });
  }
  if (timer % 20 == 0 && keysPressed["z"] && direction == 4) {
    swordSkillArray[3].push({ x: player.x, y: player.y });
    swordSkillinformation[3].push({ x: player.x, y: player.y });
  }
  for (let i = 0; i <= swordSkillArray[0].length - 1; i++) {
    swordskill = swordSkillArray[0][i];
    ctx.drawImage(swordSkillupimg, swordskill.x, swordskill.y - 50, 80, 50);
    swordskill.y -= 12;
    if (Math.abs(swordskill.y - swordSkillinformation[0][i].y) >= 160) {
      swordSkillArray[0].splice(i, 1);
      swordSkillinformation[0].splice(i, 1);
    }
  }
  for (let i = 0; i <= swordSkillArray[1].length - 1; i++) {
    swordskill = swordSkillArray[1][i];
    ctx.drawImage(
      swordSkilldownimg,
      swordskill.x - 30,
      swordskill.y + 50,
    ...
    swordskill.y += 12;
    if (Math.abs(swordskill.y - swordSkillinformation[1][i].y) >= 160) {
      swordSkillArray[1].splice(i, 1);
      swordSkillinformation[1].splice(i, 1);
    }
  }
  for (let i = 0; i <= swordSkillArray[2].length - 1; i++) {
    swordskill = swordSkillArray[2][i];
    ctx.drawImage(
      swordSkillleftimg,
      swordskill.x - 50,
      swordskill.y - 10,
    ...
    swordskill.x -= 12;
    if (Math.abs(swordskill.x - swordSkillinformation[2][i].x) >= 160) {
      swordSkillArray[2].splice(i, 1);
      swordSkillinformation[2].splice(i, 1);
    }
  }
  for (let i = 0; i <= swordSkillArray[3].length - 1; i++) {
    swordskill = swordSkillArray[3][i];
    ctx.drawImage(
      swordSkillrightimg,
      swordskill.x + 50,
      swordskill.y - 10,
    ...
    swordskill.x += 12;
    if (Math.abs(swordskill.x - swordSkillinformation[3][i].x) >= 160) {
      swordSkillArray[3].splice(i, 1);
      swordSkillinformation[3].splice(i, 1);
    }
  }
}
